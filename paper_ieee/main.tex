...
\begin{equation}
\label{eq:loss}
L(\mathbf{S}) = -\log p(\mathbf{T} \mid \mathbf{Q} \oplus \mathbf{S}) \nonumber\\
= -\sum_{j=1}^{|\mathbf{T}|} \log p(t_j \mid \mathbf{Q} \oplus \mathbf{S}, t_1, \ldots, t_{j-1}),
\end{equation}
...
\lim_{\tau \to 0} \; \mathbf{p}_i = \text{one\_hot}\!\left(\arg\max_{k} \; l_i^{(k)} + G_i^{(k)}\right) \nonumber\\
\overset{d}{=} \text{one\_hot}\!\left(\arg\max_{k} \; l_i^{(k)}\right),
\end{equation}
...
\frac{\partial \mathcal{S}(\mathbf{p}_i)}{\partial l_i^{(k)}} = \frac{\partial p_i^{(k)}}{\partial l_i^{(k)}} \nonumber\\
= \frac{1}{\tau} p_i^{(k)} \left(1 - p_i^{(k)}\right).
\end{equation}
...
\begin{equation}
\label{eq:chain_rule}
\frac{\partial L}{\partial \mathbf{l}_i} = \underbrace{\frac{\partial L}{\partial \mathbf{e}_i}}_{\text{LLM}} \cdot \underbrace{\frac{\partial \mathbf{e}_i}{\partial \mathbf{p}_i}}_{\text{Emb.}} \nonumber\\
\cdot \underbrace{\frac{\partial \mathbf{p}_i}{\partial \mathbf{l}_i}}_{\text{Gumbel}} \cdot \underbrace{\frac{\partial \mathcal{S}(\mathbf{p}_i)}{\partial \mathbf{p}_i}}_{\text{STE}},
\end{equation}
...
\text{SNR}_k = \frac{\mathbb{E}\left[\|\mathbf{P}_k \mathbf{s}_t\|_2^2\right]}{\mathbb{E}\left[\|\mathbf{P}_k \mathbf{n}_t\|_2^2\right]} \nonumber\\
= \frac{\sum_{i=1}^{k} \lambda_i}{k \sigma_n^2} \geq \frac{\lambda_1}{\sigma_n^2} \cdot \frac{\text{SNR}_{\text{full}}}{d/k},
\end{equation}
...
\begin{equation}
\text{SNR}_k = \frac{\sum_{i=1}^{k} \lambda_i}{k \sigma_n^2} \geq \frac{\lambda_1}{\sigma_n^2} \cdot \frac{1}{d/k} \nonumber\\
\cdot \frac{\sum_{i=1}^{d} \lambda_i}{d \sigma_n^2} \cdot \frac{d \sigma_n^2}{\sum_{i=1}^{d} \lambda_i} = \frac{\lambda_1}{\sigma_n^2} \cdot \frac{\text{SNR}_{\text{full}}}{d/k}.
\end{equation}
...
\begin{equation}
\text{SNR}_k = \frac{C \sum_{i=1}^{k} i^{-\beta}}{k \sigma_n^2} \nonumber\\
\geq \frac{C \zeta(\beta)}{k \sigma_n^2} \left(1 - \frac{k^{1-\beta}}{(\beta - 1)\zeta(\beta)}\right).
\end{equation}
...
\begin{equation}
\frac{\mu_k}{2} \|\mathbf{S} - \mathbf{S}'\|_2^2 \leq L(\mathbf{S}') - L(\mathbf{S}) \nonumber\\
...
\begin{equation}
L(\mathbf{S}_t) - L(\mathbf{S}^*) \leq \left(1 - \frac{\mu_k}{L_k}\right)^t \nonumber\\
\cdot \left(L(\mathbf{S}_0) - L(\mathbf{S}^*)\right) + \frac{\sigma_n^2 k}{2 \mu_k},
\end{equation}
...
L(\mathbf{S}_t) - L(\mathbf{S}^*) \leq \left(1 - \frac{\mu}{L}\right)^t \nonumber\\
\cdot \left(L(\mathbf{S}_0) - L(\mathbf{S}^*)\right) + \frac{\sigma_n^2 d}{2 \mu}.
\end{equation}
\end{theorem}
...
\begin{equation}
\mathbb{E}[L(\mathbf{S}_{t+1})] \leq \mathbb{E}[L(\mathbf{S}_t)] \nonumber\\
...
\begin{equation}
\mathbb{E}[L(\mathbf{S}_{t+1}) - L(\mathbf{S}^*)] \leq \left(1 - \frac{\mu_k}{L_k}\right) \nonumber\\
\cdot \mathbb{E}[L(\mathbf{S}_t) - L(\mathbf{S}^*)] + \frac{k \sigma_n^2}{2 L_k}.
\end{equation}
...
\min_{1 \leq t \leq T} \mathbb{E}\left[\|\nabla_{\mathcal{U}_{k^*}} L(\mathbf{S}_t)\|_2^2\right] \nonumber\\
\leq \frac{2(L(\mathbf{S}_0) - L^*)}{\eta T} + \frac{\eta L_k k^* \sigma_n^2}{2} + O\!\left(\frac{1}{\sqrt{\beta T}}\right),
\end{equation}
